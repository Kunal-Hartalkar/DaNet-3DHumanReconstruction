...
from datasets.pw3d_eval_dataset import PW3DEvalDataset
...
def main():
    ...
    dataset = PW3DEvalDataset(dataset_path, img_wh=args.img_wh)
    ...
    save_path = '/data/cvfs/as2562/DaNet-3DHumanReconstruction/evaluations/3dpw'
